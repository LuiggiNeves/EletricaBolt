    ...
    <div class="box-footer">
        <div class="container-footer">
            ...
            <div class="footer-contato">
                <h2>Contato</h2>
                <div class="img-text-generic">
                    <a href="#"><img src="<?php echo HOST_APP; ?>/app/view/images/gmail.png" alt=""></a>
                    <p>eletricaboltlimeira@gmail.com</p>
                </div>
                <div class="img-text-generic">
                    <a href="#"><img src="<?php echo HOST_APP; ?>/app/view/images/tell.png" alt=""></a>
                    <p>(19)3441-9868</p>
                </div>
                <div class="img-text-generic">
                    <a href="#"><img src="<?php echo HOST_APP; ?>/app/view/images/wpp-footer.png" alt=""></a>
                    <p>(19) 98117-5834</p>
                </div>
            </div>
